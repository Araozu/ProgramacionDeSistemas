...
void imprimirMenuOpciones() {
    ...
    std::cout << "6.- Borrar un fichero" << std::endl;
    std::cout << "7.- Modificar un fichero" << std::endl;
    std::cout << "8.- Ordenar los ficheros" << std::endl;
...
int main() {
    ...
    do {
        ...
        switch (numOpcion) {
            ...
            case 6: {
                numeroFichas = eliminarFichero(numeroFichas, fichas);
                break;
            }
            case 7: {
                modificarFichero(numeroFichas, fichas);
                break;
            }
            case 8: {
                ordenarFicheros(numeroFichas, fichas);
                break;
            }
            case 9: {
